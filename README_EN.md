<p align="center">
  <img src="image/logo.png" width="130" alt="CortexHub Logo"/>
</p>

<h1 align="center">🧠 CortexHub</h1>

<p align="center">
  <b>Enterprise AI Brain</b> — an enterprise-grade AI brain for Java teams, with zero friction<br/>
...
<p align="center">
  ...
  <a href="https://github.com/Devilfrom/CortexHub/actions/workflows/ci.yml"><img src="https://github.com/Devilfrom/CortexHub/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
...
<p align="center">
  🚀 <a href="#quick-start">Quick Start</a> · 🌐 <a href="http://43.143.235.194:8080/">Live Demo</a> (demo / demo@123456) · 📄 <a href="docs/CortexHub-商业价值白皮书.md">Whitepaper</a> · 🧪 <a href="docs/CortexHub-回归测试报告.md">Regression Report</a> · 🗒️ <a href="CHANGELOG.md">Changelog</a> · 💖 <a href="#support--sponsorship">Support Us</a>
</p>

---

## Why Choose CortexHub?

Enterprises face four common challenges when adopting LLM applications, and CortexHub answers each one:

| Pain Point                                                                                                           | CortexHub Answer                                                                                                                          |
|:---------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
...
## 📊 How CortexHub Compares

| Capability                           |         **CortexHub**         |    Dify     | MaxKB  |  FastGPT   | RAGFlow |
|:-------------------------------------|:---------------------------:|:-----------:|:------:|:----------:|:-------:|
...
docker run --name maxkb4j -d --restart always -p 8080:8080 \
  -e SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/CortexHub \
  -e SPRING_DATASOURCE_USERNAME=postgres \
  -e SPRING_DATASOURCE_PASSWORD=123456 \
  -e SPRING_DATA_MONGODB_URI=mongodb://admin:123456@localhost:27017/CortexHub?authSource=admin \
...
> If CortexHub saved your team development time, consider [buying the author a coffee ☕](#support--sponsorship) — a coffee
...
<img src="image/maxkb4j.gif" alt="CortexHubUI" />
...
- 📄 [Business Value Whitepaper](docs/CortexHub-商业价值白皮书.md) — value and selection analysis for enterprise decision
  makers
- 🧪 [Regression Test Report](docs/CortexHub-回归测试报告.md) — regression verification results of core features
...
> **CortexHub has no commercial backing and no funding** — it is built line by line by an independent developer in his
> spare time.
...
<table>
  ...
  <tr>
    <td align="center">Note "CortexHub"</td>
...
Hi, I'm **TARZAN (泰山)**, the author of CortexHub.
...
✅ **CortexHub — build high-performance, stable agent workflows and RAG knowledge base solutions with ease**
